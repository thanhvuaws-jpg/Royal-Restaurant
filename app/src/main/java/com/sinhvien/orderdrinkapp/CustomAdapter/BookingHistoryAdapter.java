...
/**
 * BookingHistoryAdapter - Adapter quản lý hiển thị danh sách lịch sử đặt bàn (Booking History) dành cho khách hàng.
 * - Hiển thị:
 *   + Tên bàn đặt (ví dụ "Bàn số 5" hoặc mã bàn dự phòng).
 *   + Giờ hẹn đến nhận bàn.
 *   + Trạng thái đặt bàn được phối màu chữ trực quan:
 *     * pending: Chờ nhận bàn (Màu cam)
 *     * confirmed: Đã xác nhận (Màu xanh dương)
 *     * checked_in: Đã nhận bàn (Màu xanh lá)
 *     * completed: Đã hoàn thành (Màu xanh dương)
 *     * overdue: Quá giờ hẹn (Màu đỏ)
 *     * cancelled: Đã hủy (Màu xám)
 *   + Tổng tiền các món ăn đặt trước (Pre-ordered dishes amount) - hiển thị cụ thể số tiền nếu có đặt trước món ăn, ngược lại hiển thị "Không có".
 */
public class BookingHistoryAdapter extends RecyclerView.Adapter<BookingHistoryAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        // Phân loại màu sắc và văn bản hiển thị theo trạng thái đặt bàn của hệ thống
        ...
        // Kiểm tra xem khách hàng có đặt trước món ăn đi kèm không
    ...
    /**
     * ViewHolder nắm giữ cấu trúc hiển thị 1 đơn đặt bàn.
     */
