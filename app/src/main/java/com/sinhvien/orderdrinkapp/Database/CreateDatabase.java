...
public class CreateDatabase extends SQLiteOpenHelper {
    ...
    public CreateDatabase(Context context) {
        super(context, "OrderDrink", null, 4);
    }
    ...
    private void initDefaultData(SQLiteDatabase db) {
        //Quyền
        db.execSQL("INSERT INTO " +TBL_QUYEN+ " (" +TBL_QUYEN_TENQUYEN+ ") VALUES ('Quản lý')");
        db.execSQL("INSERT INTO " +TBL_QUYEN+ " (" +TBL_QUYEN_TENQUYEN+ ") VALUES ('Nhân viên')");

        //Nhân viên admin
        db.execSQL("INSERT INTO " +TBL_NHANVIEN+ " (" +TBL_NHANVIEN_HOTENNV+ "," +TBL_NHANVIEN_TENDN+ "," +TBL_NHANVIEN_MATKHAU+ "," +TBL_NHANVIEN_GIOITINH+ "," +TBL_NHANVIEN_MAQUYEN+ ") " +
                "VALUES ('Quản trị viên','admin','123456','Nam', 1)");

        //Bàn ăn mẫu
        db.execSQL("INSERT INTO " +TBL_BAN+ " (" +TBL_BAN_TENBAN+ "," +TBL_BAN_TINHTRANG+ ") VALUES ('Bàn 1','false')");
        db.execSQL("INSERT INTO " +TBL_BAN+ " (" +TBL_BAN_TENBAN+ "," +TBL_BAN_TINHTRANG+ ") VALUES ('Bàn 2','false')");
        db.execSQL("INSERT INTO " +TBL_BAN+ " (" +TBL_BAN_TENBAN+ "," +TBL_BAN_TINHTRANG+ ") VALUES ('Bàn 3','false')");
        db.execSQL("INSERT INTO " +TBL_BAN+ " (" +TBL_BAN_TENBAN+ "," +TBL_BAN_TINHTRANG+ ") VALUES ('Bàn 4','false')");
        db.execSQL("INSERT INTO " +TBL_BAN+ " (" +TBL_BAN_TENBAN+ "," +TBL_BAN_TINHTRANG+ ") VALUES ('Bàn 5','false')");
    }

    @Override
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        if (oldVersion < 4) {
            // Xóa hết bảng cũ để nạp lại dữ liệu mới từ assets
